            ...
            <form name="vote" method="post" onSubmit={handleSubmit}>
                ...
                <div className="row hidden-date ">
                    ...
                    <div className="col"> 
                        ...
                        <div>
                            <select className="form-select" id="vote_date_month" name="vote[date][month]">
                                <option selected value={month}></option>
                            </select>
                            <select className="form-select" id="vote_date_day" name="vote[date][day]" value={month}>
                                <option selected value={day}></option>
                            </select>
                            <select className="form-select" id="vote_date_year" name="vote[date][year]" >
