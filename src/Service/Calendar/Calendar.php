...
{   
    ...
    private function fillCalendarTableObj($numberOfDays, $firsDayDate)
    {
        ...
        for ($i=0; $i < $numberOfDays ; $i++) { 
            ...
            $newDay->generateStatus($this->game, $events);
    ...
    public function setupGameCalendarByDateApi($date, $game, $user)
    {      
        $this->game = $game;
        $this->user = $user;
        ...
        $this->createCalendarTable($reaminingDays, $startDate);

        //adding current month to the table

        $this->createCalendarTable($lastDayOfMonthNumber, $firstDayOfMonthDateVar);
        ...
        $this->createCalendarTable($nextMonthRemainingDays, $firstDayOfMonthDateVar->modify("+1 months"));
    ...
    private function createCalendarTable($numberOfDays, $firsDayDate)
    {
